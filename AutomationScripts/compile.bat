...
runUAT BuildCookRun -project="%mypath:~0,-1%/%src%" -platform=%platform% -clientconfig=DebugGame -build -cook -stage -archive -cookflavor=Multi -nop4 -utf8output -nocompileeditor -skipbuildeditor -stage -archive -package -build -pak -iostore -compressed -prereqs -archivedirectory="%mypath:~0,-1%/%dest%" -notools
