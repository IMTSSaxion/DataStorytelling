...
runUAT BuildCookRun -project="%mypath:~0,-1%/%src%" -platform=%platform% -clientconfig=DebugGame -build -cook -stage -archive -cookflavor=Multi -archivedirectory="%mypath:~0,-1%/%dest%" -notools
