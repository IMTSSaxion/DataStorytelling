...
runUAT -ScriptsForProject="%mypath:~0,-1%/%src%" Turnkey -command=VerifySdk -platform=Android -UpdateIfNeeded -EditorIO -EditorIOPort=61394  -project="%mypath:~0,-1%/%src%" BuildCookRun -nop4 -utf8output -nocompileeditor -skipbuildeditor -cook  -project="%mypath:~0,-1%/%src%" -target=UnrealProject  -unrealexe="D:\Games\UE_5.1\Engine\Binaries\Win64\UnrealEditor-Cmd.exe" -platform=Android  -cookflavor=Multi -installed -stage -archive -package -build -pak -iostore -compressed -prereqs -archivedirectory="%mypath:~0,-1%/%dest%" -clientconfig=Development -nocompile -nocompileuat
@REM runUAT -notools -ScriptsForProject="%mypath:~0,-1%/%src%" Turnkey -command=VerifySdk -platform=Android -UpdateIfNeeded  -project="%mypath:~0,-1%/%src%" BuildCookRun -nop4 -utf8output -nocompileeditor -skipbuildeditor -cook  -project="%mypath:~0,-1%/%src%" -target=UnrealProject  -cookflavor=Multi -installed -stage -archive -package -build -pak -iostore -compressed -prereqs -archivedirectory="%mypath:~0,-1%/%dest%" 
@REM runUAT BuildCookRun -project="%mypath:~0,-1%/%src%" -platform=%platform% -clientconfig=DebugGame -build -cook -stage -archive -cookflavor=Multi -nop4 -utf8output -nocompileeditor -skipbuildeditor -stage -archive -package -build -pak -iostore -compressed -prereqs -archivedirectory="%mypath:~0,-1%/%dest%" -notools
